...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <link rel="stylesheet" href="assets/packages/daterangepicker/daterangepicker.css">
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand d-inline-flex" href="index.php"><img class="d-inline-block" src="assets/img/gallery/logo.svg" alt="logo" /><span class="text-1000 fs-3 fw-bold ms-2 text-gradient">Book a chef</span></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 my-2 mt-lg-0 justify-content-end " id="navbarSupportedContent">
            ...
            <div id="orders_menu" class="input-group-icon pe-4" style="cursor:pointer;margin-top:10px;color:orange;font-size:17px">Orders</div>
            <div id="profile_menu" class="input-group-icon pe-4" style="cursor:pointer;margin-top:10px;color:orange;font-size:17px">Profile</div>
              ...
              { 
                ...
                echo '<button class="btn btn-white shadow-warning text-warning" onclick="window.location.href=\'login.php\';" style="margin:0px 5px 0px 5px;" type="button"> <i class="fas fa-user me-2"></i>Login</button>
                <button class="btn btn-white shadow-warning text-warning" onclick="window.location.href=\'signup.php\';" style="margin:0px 5px 0px 5px;" type="button"> <i class="fas fa-user me-2"></i>Register</button>';
              }
              ?>
